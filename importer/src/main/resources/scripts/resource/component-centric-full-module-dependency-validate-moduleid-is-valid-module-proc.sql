...
/********************************************************************************
	component-centric-full-module-dependency-validate-moduleid-is-valid-module-proc.sql

	Defines a procedure to validate whether a moduleId is a descendant of valid module in in Module Dependency Full file

********************************************************************************/

drop procedure if exists validateModuleIdIsValidModuleInModuleDependencyFull_proc;
create procedure validateModuleIdIsValidModuleInModuleDependencyFull_proc(runId bigint, assertionId varchar(36), tableName varchar(255), columnName varchar(255), expression varchar(4000))
begin
