/********************************************************************************
	component-centric-full-module-dependency-id-is-same-for-the-same-moduledependency

	Assertion:
	For each record in Module Dependency Full file, the UUID is same for the same record
...
********************************************************************************/
	...
	select
		...
		'<ASSERTIONUUID>',
		a.moduleid,
		concat('Refset with id = ',a.id,' in Module Dependency Full file is not same id for refsetId = ',a.refsetid,
    ...
    from curr_moduleDependency_f t1
    join curr_moduleDependency_f t2
