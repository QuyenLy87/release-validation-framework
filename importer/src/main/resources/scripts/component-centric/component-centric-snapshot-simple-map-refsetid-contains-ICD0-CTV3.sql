/********************************************************************************
	component-centric-snapshot-simple-map-refsetid-contains-ICD0-CTV3
...
********************************************************************************/
	...
	from curr_simplemaprefset_int_s a where a.refsetid not in (900000000000497000,446608001);
	commit;