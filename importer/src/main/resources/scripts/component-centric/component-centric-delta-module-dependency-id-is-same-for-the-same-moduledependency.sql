...
********************************************************************************/
	...
	select
		...
		'<ASSERTIONUUID>',
		a.moduleid,
		concat('Refset with id = ',a.id,' in Module Dependency Delta file is not same id for refsetId = ',a.refsetid,
    ...
    from curr_moduleDependency_d t1
    join curr_moduleDependency_d t2
