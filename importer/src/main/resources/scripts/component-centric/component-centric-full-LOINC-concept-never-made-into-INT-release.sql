...
/********************************************************************************
	component-centric-full-LOINC-concept-never-made-into-INT-release
...
********************************************************************************/
	...
	select
		...
		'<ASSERTIONUUID>',
		a.moduleid,
		concat('Concept Full file with id = ',a.id,' contains description with the words LOINC Unique ID')
	from curr_concept_f a, curr_description_f b
	...
	select
		...
		'<ASSERTIONUUID>',
		a.moduleid,
		concat('Concept Full file with id = ',a.id,' in the LOINC module contains an FSN with (observable entity)')
	from curr_concept_f a, curr_description_f b
	where a.id = b.conceptid
