/********************************************************************************
	release-type-snapshot-simplemap-refset-addition-removal-ICDO-members

	Assertion:
	Verify that all additions/removals of members of ICD-O SimpleMap refset are valid:
