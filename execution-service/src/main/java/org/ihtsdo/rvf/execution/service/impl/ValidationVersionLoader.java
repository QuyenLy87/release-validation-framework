...
public class ValidationVersionLoader {
	...
	public void updateEffectiveTimeForExtensionModuleDependency(ExecutionConfig executionConfig, String effectiveTimeDependent) {
		...
		dataLoader.updateEffectiveTimeForExtensionModuleDependency(schema, effectiveTimeDependent);
	}
}
